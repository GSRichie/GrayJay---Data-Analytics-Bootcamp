-- NOTE : THe comments are the questions copied directly from the instructions document
...
ALTER TABLE actor
ADD COLUMN description BLOB(50) NOT NULL;
...
-- 6e. 6e. Using the tables `payment` and `customer` and the `JOIN` command, list the total paid by each customer. List the customers alphabetically by last name:
